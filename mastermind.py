...
def general() -> List:
    ...
    Returns:
        List: A 7 szín közül a 4 véletlenszerűen kiválasztott szín listája
    """
...
def check(bevitel:List,feladvany:List) -> str: 

    """Az a függvény eldönti, hogy a játékos által megadott 4 szín a véletlenszerűen kiválasztott színsorból eltalálta-e a színt és az jó helyen van-e (OK), 
    ...
    Args:
        ...
        feladvany (List): a 7 szín közül a 4 véletlenszerűen kiválasztott színt tároló lista
    
    Returns:
        str: Kiírja a beviteli listát, amely az " RH ", " OK ", " NO " elemeket tartalmazza. 
    """
...
def tipp() -> List:
    ...
    """Ez a függvény a szöveget számszerűsíti és elmenti a tippek listába. Ellenőrzi, hogy van e ilyen szín a megadott 7 szín között, valamint, hogy ezt a színt már nem tippelte-e a játékos.

    Returns:
        List: a számokkal megnevezett színek listája
    """
